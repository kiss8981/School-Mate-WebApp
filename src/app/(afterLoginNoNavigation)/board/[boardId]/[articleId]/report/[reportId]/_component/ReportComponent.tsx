...
const ReportComponent = (props: ReportComponentProps) => {
  ...
  const [blindArticleFetching, setBlindArticleFetching] = useState(false);
  const { triggerFetch: blindArticle } = useFetch(
    ...
    "POST",
    {
      ...
      onError: () => setBlindArticleFetching(false),
    }
  );
  return (
    <>
        ...
        >
          <div className={classNames(inter.className, "px-5 py-4")}>
            <div className="w-full">
              <span className="text-xl font-bold">해당 게시글 보지 않기</span>
              <span className="text-sm text-gray-500 block mt-2">
                해당 게시글을 보지 않도록 설정하시겠습니까?
              </span>
